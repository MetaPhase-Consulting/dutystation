...
export function NavBar() {
  ...
  const filteredStations = useMemo(() => {
    return filterStations(stations, { query: sanitizeSearchTerm(searchQuery) }).slice(0, 8);
      ...
      <div className="container flex h-14 items-center">
        <div className="mr-4 hidden md:flex">
          ...
          <nav className="flex items-center space-x-6 text-sm font-medium" aria-label="Primary">
            ...
            <Link to="/compare" className="transition-colors hover:text-[#1F631A] text-gray-600 flex items-center gap-1">
              <ArrowRightLeft className="h-4 w-4" />
              Compare
            </Link>
            <Link to="/data-sources" className="transition-colors hover:text-[#1F631A] text-gray-600 flex items-center gap-1">
        ...
        <Sheet>
          ...
          <SheetContent side="left" className="pr-0">
            <Link to="/" className="flex items-center mb-8 mt-4">
              <span className="font-bold text-[#1F631A] text-base">Duty Station</span>
            </Link>
            <nav className="flex flex-col gap-4" aria-label="Mobile Primary">
              ...
              <Link to="/compare" className="flex items-center gap-2 text-foreground hover:text-[#1F631A] transition-colors">
                <ArrowRightLeft className="h-5 w-5" />
                Compare
              </Link>
              <Link to="/data-sources" className="flex items-center gap-2 text-foreground hover:text-[#1F631A] transition-colors">
