...
describe('HomePage Component', () => {
  it('should render the main heading', () => {
    ...
    expect(screen.getByText(/Explore Your Next Assignment/i)).toBeInTheDocument()
  })
  ...
  it('should display station information', () => {
    ...
    expect(screen.getByText(/Browse duty stations with a map-first experience/i)).toBeInTheDocument()
  })
